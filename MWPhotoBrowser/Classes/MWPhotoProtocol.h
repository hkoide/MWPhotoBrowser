...
#define MWPHOTO_EAGLE_ENTRUST_STATUS_BAR
...
#define MWPHOTO_EAGLE_NO_SDWEBIMAGE
#define MWPHOTO_EAGLE_FORCE_UPDATE
#define MWPHOTO_EAGLE_DISABLE_PINCH_MODE
#define MWPHOTO_EAGLE_FIX_ROTATION_IN_LAST_PAGE
// </EAGLE>
